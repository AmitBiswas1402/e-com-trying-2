...
export function ChatSheet() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="fixed top-0 right-0 z-50 flex h-full w-full flex-col border-l border-zinc-200 bg-white overscroll-contain dark:border-zinc-800 dark:bg-zinc-950 sm:w-112 animate-in slide-in-from-right duration-300">
        {/* Header */}
